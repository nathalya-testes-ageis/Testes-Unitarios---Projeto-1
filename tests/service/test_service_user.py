...
class TestServiceUser():
    ...
    def test_add_user_success(self):
        ...
        # Chamada
        resultado = service.add_user("Nathalya", "Analista")
    ...
    def test_add_user_type_error(self):
        ...
        service.add_user("Nathalya", "Analista")

        # Chamada
        resultado = service.add_user("Nathalya", 50)
    ...
    def test_remove_user_success(self):
        ...
        # Chamada
        resultado = service.remove_user("Nathalya")
    ...
    def test_update_user_success(self):
        ...
        # Chamada
        resultado = service.update_user("Nathalya", "Desenvolvedor")
    ...
    def test_update_user_type_error(self):
        ...
        # Chamada
        resultado = service.update_user("Nathalya", [])
    ...
    def test_get_user_success(self):
        ...
        service = ServiceUser()
        service.add_user("Nathalya", "Analista")
        resultado_esperado = ("Nathalya", "Analista")

        # Chamada
        user = service.get_user_by_name("Nathalya")
